...
x11()
plot(n, x, type = "b",pch = 19, ylab = "Unidades Vendidas",xlab = "N�mero de negocio", ylim=c(min(x)-1,max(y)+1),main = "Gr�fica de unidades vendidas antes y despues de la publicidad")
